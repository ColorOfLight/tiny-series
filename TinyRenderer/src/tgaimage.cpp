...
TGAColor::TGAColor(int r, int g, int b, int a)
    : bgra{static_cast<std::uint8_t>(b), static_cast<std::uint8_t>(g),
           static_cast<std::uint8_t>(r), static_cast<std::uint8_t>(a)} {};

TGAColor::TGAColor(int r, int g, int b, int a, int bpp)
    : bgra{static_cast<std::uint8_t>(b), static_cast<std::uint8_t>(g),
           static_cast<std::uint8_t>(r), static_cast<std::uint8_t>(a)},
